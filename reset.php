...
<div class="auth-card">
    ...
    <?php else: ?>
        ...
        <form method="post" style="text-align:center;">
            ...
            <button type="submit" name="confirm" value="1" class="btn" style="background:#ff8080;color:#1a0000;box-shadow:none;">Ja, alles löschen</button>
            <a class="btn" style="background:transparent;color:#fff;border:1px solid #fff;box-shadow:none;" href="view-db.php">Abbrechen</a>
        </form>
    <?php endif; ?>
</div>
